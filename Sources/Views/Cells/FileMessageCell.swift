...
open class FileMessageCell: MessageContentCell {
    ...
    open func setupConstraints() {
        ...
        let fileImageViewLeftConstraint = fileImageView.leftAnchor.constraint(equalTo: messageContainerView.leftAnchor, constant: messageContainerView.frame.height * 0.05)
